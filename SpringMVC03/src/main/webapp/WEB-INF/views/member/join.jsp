  	...
  	function registerCheck() {
  		...
  		$.ajax({
  			...
  			success : function(result){
  				// 중복유무 출력 => result=1일 때 : 사용할 수 있는 아이디, 0일 때 : 사용할 수 없는 아이디
  				if(result==1){
		    	...
		    	<table class="table table-bordered" style="text-align : center;
		    		...
		    		<tr>
	    				...
	    				<td>
		    				...
		    				maxlength="20" placeholder ="아이디는 신뢰예요."/>
	    				</td>
	    			...
	    			<tr>
	    				...
	    				<td colspan="2">
		    				<input id="memPassword1" name="memPassword1" class="form-control"
	    			...
	    			<tr>
	    				...
	    				<td colspan="2">
		    				<input id="memPassword2" name="memPassword2" class="form-control"
		    				type="password" maxlength="20" placeholder ="비밀번호를 확인하세요."
		    				onkeyup="passwordCheck()"/>
	    				</td>
	    			</tr>
	    			...
	    			<tr>
	    				...
	    				<td colspan="2">
		    				<input id="memName" name="memName" class="form-control" type="text"
	    			...
	    			<tr>
	    				...
	    				<td colspan="2">
		    				<input id="memAge" name="memAge" class="form-control" type="number"
		    				maxlength="20" placeholder ="나이를 입력하세요."/>
	    				</td>
	    			</tr>
	    			...
	    			<tr>
	    				...
	    				<td  colspan="2">
		    				<input id="memEmail" name="memEmail" class="form-control"
		    				type="text" maxlength="20" placeholder ="이메일을 입력하세요."/>
	    				</td>
	    			</tr>
	...
	<div id="myModal" class="modal fade" role="dialog">
     ...
     <div id="myMessage" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    ...
	    </div> <!-- <div id="messageType" class="modal-content panel-info"> -->
	  </div> <!-- <div class="modal-dialog"> -->
	</div> <!-- <div id="myMessage" class="modal fade" role="dialog"> -->
